...
namespace callbot.Dialogs
{
    ...
    public class MsgForm
    {
        ...
        public static  IForm<MsgForm> BuildForm()
        {
            var parser = new Parser();
            return new FormBuilder<MsgForm>()
        ...
        public static ActiveDelegate<MsgForm> DropLocationActive => (state) => state.PickLocation != null;
        public static ActiveDelegate<MsgForm> DropDateTimeActive => (state) => !string.IsNullOrWhiteSpace(state.PickDateAndTime);
    }
